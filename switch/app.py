...
@app.route(f"/api/{API_VERSION}/switches", methods=['GET'])
def switches():
    """
    This API will return all the switches which is available with daemon.
    """
...
def rename_record():
    ...
    newname = request_data["config"][TABLE][record].get("newswitchname", "")
