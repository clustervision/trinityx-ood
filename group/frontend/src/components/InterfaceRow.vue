<template>
  <div class="tx-interface-block">
    ...
    <div class="tx-iface-grid">
      <div class="tx-field tx-field-orange">
      ...
      <div class="tx-field tx-field-orange tx-field-dhcp-wrap">
    ...
    <div class="tx-iface-grid">
      <div class="tx-field tx-field-orange">
        ...
        <select v-model="iface.bond_mode">
          <option value="">--- Select ---</option>
